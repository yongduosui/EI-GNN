...
from GOOD.data.good_datasets.good_motif_mix import GOODMotif_mix
import pdb
...
class GOODMotif(InMemoryDataset):
    ...
    @staticmethod
    def load(dataset_root: str, domain: str, shift: str = 'no_shift', generate: bool = False, rand_permute=False):
        r"""
        ...
        train_dataset   = GOODMotif(root=dataset_root, domain=domain, shift=shift, subset='train',  generate=generate)
        train_mix_dataset = GOODMotif_mix(root=dataset_root, domain=domain, shift=shift, subset='train',  generate=generate, rand_permute=rand_permute)

        id_val_dataset  = GOODMotif(root=dataset_root, domain=domain, shift=shift, subset='id_val', generate=generate) if shift != 'no_shift' else None
        id_test_dataset = GOODMotif(root=dataset_root, domain=domain, shift=shift, subset='id_test',generate=generate) if shift != 'no_shift' else None
        val_dataset     = GOODMotif(root=dataset_root, domain=domain, shift=shift, subset='val',    generate=generate)
        test_dataset    = GOODMotif(root=dataset_root, domain=domain, shift=shift, subset='test',   generate=generate)
