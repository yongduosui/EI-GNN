...
#         if m_node is not None:
#             x = x * m_node
#         post_conv = self.batch_norm1(self.conv1(x, edge_index, edge_attr, m_edge))
#         if self.num_layer > 1:
...
#             post_conv = batch_norm(conv(post_conv, edge_index, edge_attr, m_edge))
