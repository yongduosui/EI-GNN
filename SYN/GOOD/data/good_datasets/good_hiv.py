...
from GOOD.data.good_datasets.good_hiv_mix import GOODHIV_mix
import pdb
...
class GOODHIV(InMemoryDataset):
    ...
    def load(dataset_root: str, domain: str, shift: str = 'no_shift', generate: bool = False, rand_permute=False):
        ...
        train_mix_dataset = GOODHIV_mix(root=dataset_root, domain=domain, shift=shift, subset='train',  generate=generate, rand_permute=rand_permute)
